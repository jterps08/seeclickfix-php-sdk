...
abstract class CollectionAbstract implements \IteratorAggregate, \ArrayAccess, \Countable {
     ...
     * @param \SeeClickFixSDK\Core\Proxy $proxy Proxy to pass on to teh collection's objects
     * @access public
     */
    public function __construct( $raw_data = null, \SeeClickFixSDK\Core\Proxy $proxy = null ) {
        if ( $raw_data ) {
     ...
     *
     * @param \SeeClickFixSDK\Collection\CollectionAbstract $object Object to add the data of
     * @access public
     */
    public function addData( \SeeClickFixSDK\Collection\CollectionAbstract $object ) {
     ...
     *
     * @param \SeeClickFixSDK\Core\Proxy $proxy
     * @access public
     */
    public function setProxies( \SeeClickFixSDK\Core\Proxy $proxy ) {
